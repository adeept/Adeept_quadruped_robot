...
def loop():					  #GUI
	...
	while True:
		...
		root.geometry('380x280')  #Main window size, middle of the English letter x.
		...
		Btn_LeftSide.place(x=30+x_add,y=195)
		Btn_LeftSide.bind('<ButtonPress-1>', call_auto)

		Btn_RightSide = tk.Button(root, width=8, text='Steady',fg=color_text,bg=color_btn,relief='ridge')
		Btn_RightSide.place(x=170+x_add,y=195)
		Btn_RightSide.bind('<ButtonPress-1>', call_attack)

		Btn0.place(x=100+x_add,y=195)
		Btn1.place(x=100+x_add,y=230)
		Btn2.place(x=30+x_add,y=230)
		Btn3.place(x=170+x_add,y=230)
